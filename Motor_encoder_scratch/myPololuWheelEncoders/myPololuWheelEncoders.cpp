...
#include <stdlib.h>
#include "myPololuWheelEncoders.h"	// Changed by Luke
...
// Altered interrupt service routine definition to only work on PCINT2, which 
// corresponds to Port D (digital lines 0-7) on the Arduino. This avoids 
// conflicts with mySoftwareSerial which is communicating on 
// Arduino Port B (digital lines 8-13). 
// ISR(PCINT0_vect) 		original line
ISR(PCINT2_vect)
{
