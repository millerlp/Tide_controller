...
#harms1$speed = harms1$speed * intScale	# There is no advantage to scaling speed
										# at least without truncating digits
...
cat('//-----------------------------------------------------\n')
cat('// Begin pasted section from R script "tide_extract_1site_harmonics_progmem.R"\n')
...
cat('PROGMEM prog_uint16_t Equilarg[')
cat(keep.years)
cat('][37] = { \n')
...
cat('PROGMEM prog_uint16_t Nodefactor[')
cat(keep.years)
cat('][37] = { \n')
...
#cat('PROGMEM prog_int16_t currYear[] = {')
